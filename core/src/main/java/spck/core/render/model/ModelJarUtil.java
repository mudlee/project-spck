...
public class ModelJarUtil {
    ...
    public static String unpackFromJar(String resourcePath, String extension) {
        ...
        try {
            ...
            InputStream modelInput = ModelJarUtil.class.getResourceAsStream(resourcePath);
            ...
            InputStream mtlInput = ModelJarUtil.class.getResourceAsStream(resourcePath.replace(extension, ".mtl"));
            if (mtlInput == null) {
            ...
            InputStream textureInput = ModelJarUtil.class.getResourceAsStream(resourcePath.replace(extension, ".png"));
